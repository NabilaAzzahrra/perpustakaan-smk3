        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex gap-5 items-start">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg w-1/2 p-4">
                    ...
                    <div>
                        <form class="max-w-sm mx-auto" method="POST" action="{{ route('sumber.store') }}">
                            @csrf
                            <div class="mb-5">
                                ...
                                <input type="text" id="kode_sumber" name="kode_sumber"
                                    ...
                                    placeholder="Kode Sumber" value="{{$kodeSumber}}" readonly required />
                            </div>
                            <div class="mb-5">
                                <label for="sumber"
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4">
                                                <button type="button"
                                                    ...
                                                    data-id="{{ $f->id }}" data-kode_sumber="{{ $f->kode_sumber }}"
                                                    data-sumber="{{ $f->sumber }}">
                                                    <i class="fi fi-sr-file-edit"></i>
                                                </button>
                                                <button
                                                    class="bg-red-400 p-3 w-10 h-10 rounded-xl text-white hover:bg-red-500"
                                                    onclick="return dataDelete('{{ $f->id }}','{{ $f->sumber }}')">
            ...
            <div class="w-full md:w-1/2 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="mb-5">
                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900">Kode Sumber</label>
                            <input type="text" id="kode_sumber_edit" name="kode_sumber"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                id="" placeholder="Masukan kode sumber disini...">
                        </div>
                        <div class="mb-5">
                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900">Sumber</label>
                            <input type="text" id="sumber_edit" name="sumber"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                id="" placeholder="Masukan sumber disini...">
                        </div>
                    </div>
...
<script>
    const editSourceModal = (button) => {
            ...
            document.getElementById('title_source').innerText = `Update Sumber ${sumber}`;
...
        }
        const dataDelete = async (id, sumber) => {
                let tanya = confirm(`Apakah anda yakin untuk menghapus Sumber ${sumber} ?`);
                if (tanya) {
